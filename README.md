# Проверка ДЗ:
Открыть один терминал по адресу папки и задать команду 
sh
 npm run start
 

Открыть второй терминал по тому же адресу,
тесты были написаны интеграционно на Гермионе, так что для пуска будет достаточно сделать команду
sh
 npm run test:e2e gui
 

Чтобы прокинуть баги в тест - в первом терминале (на примере 3. бага) нужно задать команду:
sh
